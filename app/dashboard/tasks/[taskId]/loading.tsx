    ...
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:gap-x-4">
          <Skeleton className="h-10 w-full sm:w-[140px]" /> {/* Attendees */}
          <Skeleton className="h-10 w-full sm:w-[120px]" /> {/* View Blog */}
          <Skeleton className="h-10 w-full sm:w-[120px]" /> {/* Settings */}
          <Skeleton className="h-10 w-full sm:w-[140px]" /> {/* Create Article */}
        </div>
      </div>
